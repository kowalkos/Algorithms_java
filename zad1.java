...
public class zad1 {
    ...
    public static void permutacje(ArrayList<Double[]> data, ArrayList<Integer> primarytable) {
        ...
        do {
            ...
            // ArrayList<Integer> neighbour_solution=newsolution_First(primarytable,data);
            ArrayList<Integer> neighbour_solution = newsolution_First(primarytable, data);
            if (ocen(neighbour_solution, data) < ocen(primarytable, data)) {
                primarytable = new ArrayList<Integer>();
    ...
    public static void main(String[] args) {
        ...
        int[] tab = { 27, 43, 11, 7, 1, 18, 33, 47, 39, 30, 37, 32, 22, 50, 31, 46, 24, 14, 5, 16, 40, 34, 51, 9, 41, 4,
                8, 2, 12, 0, 36, 48, 38, 23, 15, 6, 10, 3, 20, 19, 29, 42, 35, 26, 49, 17, 28, 45, 13, 25, 21, 44 };
        lista.clear();
        for (int i = 0; i < tab.length; i++) {
            lista.add(tab[i]);
        }
